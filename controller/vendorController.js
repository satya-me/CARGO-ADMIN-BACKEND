...
exports.getAllVendors = async (req, res) => {
    ...
    // return;
    try {
        const allVendors = await VendorModel.find().populate({
            path: '_airlineId',
            select: '_id airline person_name person_designation email phone role status isDeleted type'
        });
...
exports.getAllBookingData = async (req, res) => {
    ...
    try {
        const allBookings = await BookingModel.find().populate({
            path: '_vendorId',
            select: '_id type vendor_name reporting_person_name reporting_person_email reporting_person_phone reporting_person_alt_phone HO_address status isDeleted vendor_logo'
        });
